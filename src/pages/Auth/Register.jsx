...
const handleGoogleLogin = () => {
  ...
  return (
    <div className="pt-18 flex flex-col items-center justify-center bg-gray-100 px-4">
      <form onSubmit={handleRegister} className="bg-white p-8 rounded shadow-md w-full max-w-md space-y-4">
        ...
        <div className="relative">
          <input
            ...
            minLength="6"
            pattern="(?=.*[a-z])(?=.*[A-Z]).{6,}"
            title="Password must be at least 6 characters with uppercase and lowercase letters"
          />
          <button
            type="button"
